...
# Exclude build/artifact dirs + our two contract dirs + common binaries
tree -a -I "node_modules|.git|.next|coverage|dist|build|artifacts|typechain-types|*.pack.gz|*.webp|*.cache|package-lock.json|pnpm-lock.yaml|yarn.lock|*.ico|*.png|*.jpg|*.jpeg|*.svg|*.gif|.DS_Store|abis|main.0d424902.js|.env" band-oracle-monorepo >> "$OUTPUT_FILE" 2>/dev/null
...
find band-oracle-monorepo -type f \
